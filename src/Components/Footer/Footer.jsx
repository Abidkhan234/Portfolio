...
const Footer = () => {
  ...
  return (
    <div className="flex flex-col gap-5 py-3">
      <div className="flex min-[426px]:justify-between items-center gap-4 flex-wrap justify-center">
        ...
        <div className="flex gap-4 items-center flex-wrap max-[375px]:justify-center max-[376px]:order-3 overflow-hidden">
          {navLinks.map((v, i) => {
            return (
              <NavLink
                key={i}
        ...
        <div className="flex items-center gap-3 max-[376px]:order-1">
          {mediaIcons.map((v, i) => {
            return (
              <NavLink
                to={v.path}
                className="min-[376px]:p-3 p-2 bg-[#5700FF] text-xl text-white rounded-md inset-shadow-[0_0_7px_2px_#fff]"
                key={i}
                data-aos="fade-up"
                data-aos-duration="500"
      ...
      <div className="flex justify-center items-center">
        <div className="border-2 border-[#E1DBD1] flex min-[426px]:justify-between items-center w-full max-w-[650px] py-2.5 px-4 rounded-sm flex-wrap justify-center max-[426px]:gap-4">
          {detailArr.map((v, i) => {
            return (
